        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
          <div className="space-y-6">
            <div className="prose prose-lg text-muted-foreground">
              <p>
                I'm a dedicated MERN stack developer with over 1 years of
                experience building scalable web applications. My journey in web
                development started with a curiosity about how modern
                applications work, which evolved into a passion for creating
                efficient, user-friendly solutions.
              </p>
              <p>
                I specialize in developing full-stack JavaScript applications,
                from designing robust MongoDB databases to creating intuitive
                React interfaces. My expertise spans the entire development
                lifecycle, including system architecture, implementation,
                testing, and deployment.
              </p>
              <p>
                When I'm not coding, I contribute to open-source projects, write
                technical blog posts, and explore emerging technologies in the
                JavaScript ecosystem. I believe in continuous learning and
        ...
        <div className="bg-gradient-glow rounded-xl p-[1px]">
          <div className="bg-background rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-terminal mb-2">
                  100%
                </div>
